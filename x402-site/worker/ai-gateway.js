/* ============================================================
   x402-ai-agent.space — AI gateway Worker
   Проксирует запросы виджета в OpenRouter (бесплатная модель).
   Ключ хранится в секрете OPENROUTER_API_KEY (wrangler secret),
...
// Бесплатная модель OpenRouter (самая стабильная из :free — Google Gemma 2 9B)
...
export default {
  async fetch(request, env) {
    ...
    return new Response("x402-ai-agent.space AI gateway. POST /api/chat", { status: 200 });
  },
};
